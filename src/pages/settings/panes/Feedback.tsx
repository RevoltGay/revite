    ...
    return (
        <Column>
            <Tip palette="warning">
                <span>
                    ...
                    <a
                        ...
                        href="https://github.com/RevoltGay/frontend/issues/14"
                        target="_blank"
                        rel="noreferrer">
            ...
            <div className={styles.feedback}>
                <a
                    href="https://github.com/RevoltGay/revite/issues/new"
                    target="_blank"
                    rel="noreferrer">
                    <CategoryButton
                        action="external"
                ...
                <a
                    href="https://github.com/RevoltGay/revite/issues/new/choose"
                    target="_blank"
                    rel="noreferrer">
                    <CategoryButton
                        action="external"
